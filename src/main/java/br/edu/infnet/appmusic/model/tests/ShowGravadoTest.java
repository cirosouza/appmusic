...
public class ShowGravadoTest {
	...
	public static void main(String[] args) {
		try {
			ShowGravado show1 = new ShowGravado("Iron Maiden Rock in Rio", 120, 2002, "Rio de Janeiro", 19, "Kevin Shirley");
		...
		try {
			ShowGravado show2 = new ShowGravado(null, 120, 2002, "Rio de Janeiro", 19, "Kevin Shirley");
		...
		try {
			ShowGravado show3 = new ShowGravado("Iron Maiden Rock in Rio", 120, 2002, null, 19, "Kevin Shirley");
